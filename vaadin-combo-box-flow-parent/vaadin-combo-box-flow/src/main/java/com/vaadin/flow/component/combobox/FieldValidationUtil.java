...
/**
 * Utility class for ComboBox Flow component to disable client side validation.
 *
 * @author Vaadin Ltd
 */
final class FieldValidationUtil {
    ...
    static void disableClientValidation(ComboBoxBase<?, ?, ?> component) {
