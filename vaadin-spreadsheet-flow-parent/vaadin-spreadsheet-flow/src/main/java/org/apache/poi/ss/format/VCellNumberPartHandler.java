...
import org.apache.poi.ss.format.VCellFormatPart.PartHandler;
 ...
 */
@Internal
public class VCellNumberPartHandler implements PartHandler {
    ...
    @Override
    public String handlePart(Matcher m, String part, VCellFormatType type, StringBuffer descBuf) {
