...
import org.apache.poi.ss.format.VCellNumberFormatter.Special;
...
public class VCellNumberStringMod implements Comparable<VCellNumberStringMod> {
    ...
    public VCellNumberStringMod(Special special, CharSequence toAdd, int op) {
        this.special = special;
        this.toAdd = toAdd;
        this.op = op;
    }

    public VCellNumberStringMod(Special start, boolean startInclusive, Special end, boolean endInclusive, char toAdd) {
        this(start, startInclusive, end, endInclusive);
        this.toAdd = toAdd + "";
    }

    public VCellNumberStringMod(Special start, boolean startInclusive, Special end, boolean endInclusive) {
        special = start;
    ...
    @Override
    public int compareTo(VCellNumberStringMod that) {
    ...
    public boolean equals(Object that) {
        return (that instanceof VCellNumberStringMod) && compareTo((VCellNumberStringMod) that) == 0;
    }
