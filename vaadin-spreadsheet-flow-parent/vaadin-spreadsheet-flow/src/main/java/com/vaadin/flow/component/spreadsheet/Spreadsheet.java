...
public class Spreadsheet extends Component implements HasComponents, HasSize, HasStyle,
     ...
     * {@link Action.Handler#getActions(Object, Object)} depend on the actual target of
     * the right click.
     * <p>
     * The second parameter (sender) on
     * {@link Action.Handler#getActions(Object, Object)} is always the spreadsheet
     ...
     * <p>
     * Similarly for {@link Action.Handler#handleAction(Action, Object, Object)} the
    ...
    public void addRowHeaderDoubleClickListener(
        ...
        addListener(RowHeaderDoubleClickEvent.class, listener::onRowHeaderDoubleClick); //, RowHeaderDoubleClickListener.ON_ROW_ON_ROW_HEADER_DOUBLE_CLICK);
    }
     ...
     */
    public abstract static class ValueChangeEvent extends ComponentEvent<Component> {
    ...
    public void addSelectionChangeListener(SelectionChangeListener listener) {
        addListener(SelectionChangeEvent.class, listener::onSelectionChange); //, SelectionChangeListener.SELECTION_CHANGE_METHOD);
    }
    ...
    public void addCellValueChangeListener(CellValueChangeListener listener) {
        addListener(CellValueChangeEvent.class, listener::onCellValueChange); //, CellValueChangeListener.CELL_VALUE_CHANGE_METHOD);
    }
    ...
    public void addFormulaValueChangeListener(
        ...
        addListener(FormulaValueChangeEvent.class, listener::onFormulaValueChange); //, FormulaValueChangeListener.FORMULA_VALUE_CHANGE_METHOD);
    }
    ...
    public void removeSelectionChangeListener(SelectionChangeListener listener) {
        ...
        //removeListener(SelectionChangeEvent.class, listener, SelectionChangeListener.SELECTION_CHANGE_METHOD);
    }
    ...
    public void removeCellValueChangeListener(CellValueChangeListener listener) {
        //todo: el método removeListener no existe en Component
        //removeListener(CellValueChangeEvent.class, listener, CellValueChangeListener.CELL_VALUE_CHANGE_METHOD);
    }
    ...
    public void addProtectedEditListener(ProtectedEditListener listener) {
        addListener(ProtectedEditEvent.class, listener::writeAttempted); //, ProtectedEditListener.SELECTION_CHANGE_METHOD);
    }
    ...
    public void removeProtectedEditListener(ProtectedEditListener listener) {
        //todo: el método removeListener no existe en Component
        //removeListener(ProtectedEditEvent.class, listener, ProtectedEditListener.SELECTION_CHANGE_METHOD);
    }
    ...
    public void addSheetChangeListener(SheetChangeListener listener) {
        addListener(SheetChangeEvent.class, listener::onSheetChange); //, SheetChangeListener.SHEET_CHANGE_METHOD);
    }
    ...
    public void removeSheetChangeListener(SheetChangeListener listener) {
        //todo: el método removeListener no existe en Component
        //removeListener(SheetChangeEvent.class, listener, SheetChangeListener.SHEET_CHANGE_METHOD);
    }
