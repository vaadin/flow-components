...
class CustomEditorFactory implements SpreadsheetComponentFactory {
...
enum EditorType {
    TEXT_FIELD(1, "TextField"), CHECKBOX(2, "Checkbox"), DATE_PICKER(3,
            "DatePicker"), TEXT_AREA(4, "TextArea"), COMBO_BOX(5, "ComboBox");
    ...
    public static EditorType getEditorTypeByIndex(int row, int col) {
        if (row != SimpleCustomEditorFixture.COMPONENT_ROW_INDEX) {
            return null;
        }
