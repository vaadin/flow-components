...
public enum TestFixtures {
    FirstColumnWidth(FirstColumnWidthFixture.class), PopupButton(
            ...
            DisableChartsFixture.class), StyleMergeReigions(com.vaadin.flow.component.spreadsheet.tests.fixtures.StyleMergeReigions.class), RemoveFixture(com.vaadin.flow.component.spreadsheet.tests.fixtures.RemoveFixture.class), DefaultStyleUnlocked(
