...
public class LitRendererTestComponent extends Div
    ...
    public void setRenderer(LitRenderer<String> renderer) {
        ...
        if (renderer != null) {
            LitRendering<String> rendering = renderer.render(getElement(), dataCommunicator.getKeyMapper());
    ...
    public void setDetailsRenderer(LitRenderer<String> renderer) {
        ...
        if (renderer != null) {
            LitRendering<String> rendering = renderer.render(getElement(), dataCommunicator.getKeyMapper(), "detailsRenderer");
