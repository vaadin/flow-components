...
NOTE: Although most visual styles are defined in CSS, some options like [parameter]#whiskerLength# are set through Java API.
...
Also, data label can be styled by CSS with [literal]#.highcharts-data-label-box# and [literal]#.highcharts-data-label# class names.
