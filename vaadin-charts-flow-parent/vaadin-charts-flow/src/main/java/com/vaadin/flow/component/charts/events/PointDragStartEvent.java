...
public class PointDragStartEvent extends ComponentEvent<Chart>
    ...
    /**
     * @return Supported only in Gantt charts: Returns the start date of the point at the moment the dragging
     *         started.
     */
    ...
    /**
     * @return Supported only in Gantt charts: Returns the end date of the point at the moment the dragging
     *         started.
     */
