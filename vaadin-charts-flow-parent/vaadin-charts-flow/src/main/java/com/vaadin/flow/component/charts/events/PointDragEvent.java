...
public class PointDragEvent extends ComponentEvent<Chart> implements HasItem {
    ...
    /**
     * @return Supported only in Gantt charts: Returns the start date of the point at the moment the Drag event
     *         was fired.
     */
    ...
    /**
     * @return Supported only in Gantt charts: Returns the end date of the point at the moment the Drag event
     *         was fired.
     */
