...
public class PlotOptionsGantt extends AbstractPlotOptions {
    ...
    private SeriesConnectors connectors;
    ...
    /**
     * @see #setDataLabels(ArrayList)
     */
    public ArrayList<DataLabels> getDataLabels() {
        if (dataLabels == null) {
     ...
     * </p>
     */
    public void setDataLabels(ArrayList<DataLabels> dataLabels) {
    ...
    /**
     * @see #setConnectors(SeriesConnectors)
     */
    public SeriesConnectors getConnectors() {
        return connectors;
    }

    /**
     * Override Pathfinder connector options for a series. Requires Highcharts
     * Gantt to be loaded.
     */
    public void setConnectors(SeriesConnectors connectors) {
