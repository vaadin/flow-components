 ...
 * the License.
 */
package com.vaadin.flow.component.paper.dialog;
 ...
 * "https://www.google.com/design/spec/components/dialogs.html">Dialogs</a>
 * </p>
 * <p>
 ...
 * in
 * <a href="https://github.com/PolymerElements/neon-animation">PolymerElements
...
public class GeneratedPaperDialog<R extends GeneratedPaperDialog<R>> extends
     ...
     * </p>
     * <p>
     * If {@code modal} is true, this implies
     * {@code no-cancel-on-outside-click}, {@code no-cancel-on-esc-key} and
     * {@code with-backdrop}.
     * <p>
     * This property is not synchronized automatically from the client side, so
     * the returned value may not be the same as in client side.
