...
public class NestedBoardUI extends UI {
    ...
    private Component createBoard() {
        ...
        board.addRow(createPieChart(),
                createChart("Foo", SalesData.generateYearData()));
        return board;
    }
    ...
    @WebServlet(urlPatterns = "/nested/*", name = "MydUIServlet", asyncSupported = true)
    @VaadinServletConfiguration(ui = NestedBoardUI.class, productionMode = false, widgetset = "com.vaadin.board.BoardWidgetSet")
