...
/* Test div so that we don't depend on the html components. */
@Tag(Tag.DIV)
public class TestDiv extends HtmlContainer {
    ...
    /**
     * Creates a new div with the given text content.
     *
     * @param text
     *            the text content
     */
    public TestDiv(String text) {
        this();
        setText(text);
    }

    /**
     * Sets the component that this div describes. The component (or its id)
    ...
    /**
     * Sets the id of the component that this div describes. The id should be
     * defined in case the described component is not an ancestor of the div.
     *
     * @param forId
    ...
    /**
     * Gets the id of the component that this div describes.
     *
     * @see #setFor(String)
     *
