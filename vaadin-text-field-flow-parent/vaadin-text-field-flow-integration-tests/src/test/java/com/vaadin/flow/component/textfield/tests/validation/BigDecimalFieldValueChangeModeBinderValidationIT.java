...
@TestPath("vaadin-big-decimal-field/validation/value-change-mode/binder")
public class BigDecimalFieldValueChangeModeBinderValidationIT
        extends AbstractValueChangeModeValidationIT<BigDecimalFieldElement> {
    @Test
