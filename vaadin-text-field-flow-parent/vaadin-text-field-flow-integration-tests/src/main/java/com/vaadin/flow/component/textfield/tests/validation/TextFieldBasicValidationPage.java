...
public class TextFieldBasicValidationPage
    ...
    public static final String MAX_LENGHT_ERROR_MESSAGE = "Value is too long";
    public static final String PATTERN_ERROR_MESSAGE = "Value does not match pattern";
    ...
    public TextFieldBasicValidationPage() {
        ...
        testField.setI18n(new TextField.TextFieldI18n()
                ...
                .setMaxLengthErrorMessage(MAX_LENGHT_ERROR_MESSAGE)
