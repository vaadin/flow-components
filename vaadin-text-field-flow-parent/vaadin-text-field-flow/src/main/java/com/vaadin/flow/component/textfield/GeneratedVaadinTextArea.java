...
@NpmPackage(value = "@vaadin/polymer-legacy-adapter", version = "22.0.2")
@JsModule("@vaadin/polymer-legacy-adapter/style-modules.js")
@NpmPackage(value = "@vaadin/text-area", version = "22.0.2")
@NpmPackage(value = "@vaadin/vaadin-text-field", version = "22.0.2")
