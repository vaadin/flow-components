...
@NpmPackage(value = "@vaadin/polymer-legacy-adapter", version = "23.3.18")
@JsModule("@vaadin/polymer-legacy-adapter/style-modules.js")
@NpmPackage(value = "@vaadin/text-area", version = "23.3.18")
@NpmPackage(value = "@vaadin/vaadin-text-field", version = "23.3.18")
