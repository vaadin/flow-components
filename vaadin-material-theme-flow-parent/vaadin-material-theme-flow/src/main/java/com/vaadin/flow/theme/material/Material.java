 ...
 */
@NpmPackage(value = "@vaadin/vaadin-themable-mixin", version = "24.6.0-alpha3")
@NpmPackage(value = "@vaadin/polymer-legacy-adapter", version = "24.6.0-alpha3")
@NpmPackage(value = "@vaadin/vaadin-material-styles", version = "24.6.0-alpha3")
