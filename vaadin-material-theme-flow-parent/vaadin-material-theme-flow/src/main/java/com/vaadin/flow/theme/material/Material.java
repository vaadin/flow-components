 ...
 *             in Vaadin 25.
 */
@NpmPackage(value = "@vaadin/vaadin-themable-mixin", version = "24.9.0-rc1")
@NpmPackage(value = "@vaadin/polymer-legacy-adapter", version = "24.9.0-rc1")
@NpmPackage(value = "@vaadin/vaadin-material-styles", version = "24.9.0-rc1")
