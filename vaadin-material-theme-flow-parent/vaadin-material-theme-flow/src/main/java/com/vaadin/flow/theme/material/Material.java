 ...
 */
@NpmPackage(value = "@vaadin/vaadin-themable-mixin", version = "24.0.13")
@NpmPackage(value = "@vaadin/polymer-legacy-adapter", version = "24.0.13")
@JsModule("@vaadin/polymer-legacy-adapter/style-modules.js")
@NpmPackage(value = "@vaadin/vaadin-material-styles", version = "24.0.13")
