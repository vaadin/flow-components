...
class SelectDataViewTest extends AbstractComponentDataViewJUnit6Test {
    ...
    void setIdentifierProvider_customIdentity_itemRefreshed() {
        ...
        Assertions.assertTrue(containsItem(component, "changed-1"));
        Assertions.assertFalse(containsItem(component, "changed-2"));
    }
