...
@NpmPackage(value = "@vaadin/icons", version = "23.1.0-rc3")
@NpmPackage(value = "@vaadin/vaadin-icons", version = "23.1.0-rc3")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "23.1.0-rc3")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "23.1.0-rc3")
