...
@NpmPackage(value = "@vaadin/icons", version = "23.2.0-dev.53560527d")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "23.2.0-dev.53560527d")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "23.2.0-dev.53560527d")
