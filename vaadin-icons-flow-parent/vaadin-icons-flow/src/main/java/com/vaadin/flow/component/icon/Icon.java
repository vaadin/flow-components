...
@NpmPackage(value = "@vaadin/icons", version = "23.2.0-beta3")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "23.2.0-beta3")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "23.2.0-beta3")
