...
@NpmPackage(value = "@vaadin/icons", version = "23.2.0-dev.8a7678b70")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "23.2.0-dev.8a7678b70")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "23.2.0-dev.8a7678b70")
