...
@NpmPackage(value = "@vaadin/icons", version = "23.2.0-dev.48e5e3967")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "23.2.0-dev.48e5e3967")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "23.2.0-dev.48e5e3967")
