...
@NpmPackage(value = "@vaadin/icons", version = "23.0.0")
@NpmPackage(value = "@vaadin/vaadin-icons", version = "23.0.0")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "23.0.0")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "23.0.0")
