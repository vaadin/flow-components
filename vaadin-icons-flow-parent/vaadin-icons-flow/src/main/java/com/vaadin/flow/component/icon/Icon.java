...
@NpmPackage(value = "@vaadin/icons", version = "23.3.0-alpha3")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "23.3.0-alpha3")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "23.3.0-alpha3")
