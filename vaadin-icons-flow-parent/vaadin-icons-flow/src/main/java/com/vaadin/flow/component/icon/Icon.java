...
@NpmPackage(value = "@vaadin/icons", version = "22.0.12")
@NpmPackage(value = "@vaadin/vaadin-icons", version = "22.0.12")
@JsModule("@vaadin/icons/vaadin-iconset.js")
@NpmPackage(value = "@vaadin/icon", version = "22.0.12")
@NpmPackage(value = "@vaadin/vaadin-icon", version = "22.0.12")
