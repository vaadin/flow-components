...
public class TreeGridChildRemovalIT extends AbstractTreeGridIT {
    ...
    /**
     * Refreshing an item recursively should remove from display all elements that
     * where removed on the server-side, including sub-children.
     * See <a href="https://github.com/vaadin/vaadin-grid/issues/1819">Issue 1819</a>.
     */
    @Test
    public void updatingRecursivelyAfterRemovingShouldRemoveAllDeleteItems() {
        // Initial state
        assertCellTexts(0, 0,
            new String[] { "Root", "child", "Sub-child", "child2", "Sub-child2",
                "child3" });

        // Remove child and refresh "Root" recursively
        $("button").id("remove1").click();
        // Expected result: "child" and "Sub-child" are removed. Others unchanged
        assertCellTexts(0, 0,
