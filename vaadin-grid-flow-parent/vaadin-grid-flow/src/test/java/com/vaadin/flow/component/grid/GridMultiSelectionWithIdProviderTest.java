...
public class GridMultiSelectionWithIdProviderTest {
    ...
    public void setUp() {
        ...
        grid = new Grid<>();
        grid.setDataProvider(new ListDataProviderPerson(mockPersons));
    ...
    public class ListDataProviderPerson extends ListDataProvider<Person> {

        public ListDataProviderPerson(Collection<Person> items) {
            super(items);
        }
