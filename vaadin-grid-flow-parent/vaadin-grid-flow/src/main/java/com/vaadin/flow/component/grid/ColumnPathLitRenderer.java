 ...
 */
class ColumnPathLitRenderer<SOURCE> extends LitRenderer<SOURCE> {
     ...
     */
    public ColumnPathLitRenderer(String property,
    ...
    public LitRendering<SOURCE> render(Element container,
        ...
        if (valueProviders.size() != 1) {
            throw new IllegalStateException(
                    "There should be only one ValueProvider for the ColumnPathLitRenderer");
        }
    ...
    private class SingleValueProviderRendering implements LitRendering<SOURCE> {
        ...
        public DataGenerator<SOURCE> getDataGenerator() {
            ...
            return (item, jsonObject) -> jsonObject.put(property,
