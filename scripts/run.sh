...
case $option in
   ...
   3) askModule; cmd="mvn package jetty:run -am -B $quiet -DskipTests -pl $module-flow-parent/$module-flow-integration-tests"; browser=true;;
   ...
   8) mergeITs; cmd="mvn package jetty:run -am -B $quiet -DskipTests -Drun-it -pl integration-tests"; browser=true;;
