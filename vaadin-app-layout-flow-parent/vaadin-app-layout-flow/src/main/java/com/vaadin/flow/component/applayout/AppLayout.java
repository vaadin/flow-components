...
@NpmPackage(value = "@vaadin/app-layout", version = "23.0.0-alpha2")
@NpmPackage(value = "@vaadin/vaadin-app-layout", version = "23.0.0-alpha2")
...
public class AppLayout extends Component implements RouterLayout {
     ...
     * <p>
     * Note: updating the i18n object that is returned from this method will
     * not update the the component, unless it is set again using
