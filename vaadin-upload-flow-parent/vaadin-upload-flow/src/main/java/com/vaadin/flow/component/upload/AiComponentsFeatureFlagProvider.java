...
/**
 * Provides the AI components feature flag for the UploadManager and related
 * components.
 *
 * @author Vaadin Ltd
 */
public class AiComponentsFeatureFlagProvider implements FeatureFlagProvider {
     ...
     * UploadManager, UploadButton, UploadFileList, and other AI-related
     * components.
     */
    public static final Feature AI_COMPONENTS = new Feature(
            "AI Components (UploadManager, etc.)", // title
            "aiComponents", // id
            "https://vaadin.com/docs/latest/components/upload", // moreInfoLink
