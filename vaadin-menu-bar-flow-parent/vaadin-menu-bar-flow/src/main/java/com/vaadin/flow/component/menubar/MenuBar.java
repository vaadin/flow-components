...
@NpmPackage(value = "@vaadin/menu-bar", version = "23.4.0-alpha4")
@NpmPackage(value = "@vaadin/vaadin-menu-bar", version = "23.4.0-alpha4")
@NpmPackage(value = "@vaadin/tooltip", version = "23.4.0-alpha4")
