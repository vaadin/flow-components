...
public class CookieConsentView extends DemoView {
	...
	private void createCard(String heading, String buttonText, CookieConsent element) {
	...
	private static String createCookieName() {
		...
		return "consentdemo-" + random.ints(0, values.length()).limit(50).mapToObj(values::charAt)
