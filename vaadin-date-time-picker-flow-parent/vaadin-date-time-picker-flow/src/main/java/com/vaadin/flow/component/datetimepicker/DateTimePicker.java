...
@NpmPackage(value = "@vaadin/polymer-legacy-adapter", version = "24.2.0-alpha10")
@JsModule("@vaadin/polymer-legacy-adapter/style-modules.js")
@NpmPackage(value = "@vaadin/date-time-picker", version = "24.2.0-alpha10")
...
public class DateTimePicker extends
    ...
    public Registration addValidationStatusChangeListener(
        ...
        return Registration.combine(addIncompleteChangeListener(
                event -> listener.validationStatusChanged(
                        new ValidationStatusChangeEvent<>(this, !isInvalid()))),
                addUnparseableChangeListener(
                        event -> listener.validationStatusChanged(
    ...
    private ValidationResult checkValidity(LocalDateTime value) {
        boolean hasDatePickerValue = !Objects.equals(datePicker.getValue(),
                datePicker.getEmptyValue());
        boolean hasTimePickerValue = !Objects.equals(timePicker.getValue(),
                timePicker.getEmptyValue());

        boolean hasNonParsableDatePickerValue = !hasDatePickerValue
                && datePicker.isInputValuePresent();
        boolean hasNonParsableTimePickerValue = !hasTimePickerValue
        ...
        if ((hasDatePickerValue && !hasTimePickerValue)
                || (!hasDatePickerValue && hasTimePickerValue)) {
