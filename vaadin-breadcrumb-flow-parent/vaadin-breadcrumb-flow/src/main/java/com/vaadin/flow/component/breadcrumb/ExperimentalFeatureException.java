 ...
 * {@link Breadcrumb} component without activating the associated feature flag
 * first.
 *
 * @author Vaadin Ltd
 */
public class ExperimentalFeatureException extends RuntimeException {
    public ExperimentalFeatureException() {
        super("""
                The Breadcrumb component is currently an experimental feature \
                ...
                `com.vaadin.experimental.breadcrumbComponent=true`""");
    }
}
