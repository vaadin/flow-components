...
@Route("vaadin-rich-text-editor/as-delta-binder")
public class RichTextEditorAsDeltaBinderPage extends Div {
    private TestBean testBean = new TestBean();

    public RichTextEditorAsDeltaBinderPage() {
        ...
        binder.forField(editor.asDelta())
