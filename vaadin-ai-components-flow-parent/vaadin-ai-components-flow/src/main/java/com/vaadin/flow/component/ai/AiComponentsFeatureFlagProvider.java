...
/**
 * Provides the AI components feature flag for the AiOrchestrator and related
 * components.
 *
 * @author Vaadin Ltd
 */
public class AiComponentsFeatureFlagProvider implements FeatureFlagProvider {
     ...
     * AiOrchestrator and other AI-related components.
     */
    public static final Feature AI_COMPONENTS = new Feature(
            "AI Components (AiOrchestrator, etc.)", // title
            "aiComponents", // id
