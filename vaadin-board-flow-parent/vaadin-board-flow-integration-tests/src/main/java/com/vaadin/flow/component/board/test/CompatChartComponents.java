...
public class CompatChartComponents {
    ...
    @Route("BarChartView")
    public static class BarChartView extends CompatBasicChartView {
    ...
    // DASH-110
    public static class PieChartView extends CompatBasicChartView {
    ...
    @Route("CombinationsMultipleAxisView")
    public static class CombinationsMultipleAxisView
            extends CompatBasicChartView {
        ...
        protected Component getChart() {
            ...
            series.setData(7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3,
                    18.3, 13.9, 9.6);
            conf.addSeries(series);
    ...
    @Route("GaugeView")
    public static class GaugeView extends CompatBasicChartView {
        @Override
        protected Component nextChartInstance() {
    ...
    @Route("TimeLineView")
    public static class TimeLineView extends CompatBasicChartView {
        ...
        public static class StockPrices {
            ...
            public static class OhlcData extends TimeData {
                ...
                private OhlcData(long date, double open, double high,
            ...
            public List<PriceData> fetchAaplPriceWithTime() {
                List<PriceData> data = readValueData(
                        "aapl-price-withtime.json");
                return Collections.unmodifiableList(data);
            }
            ...
            private static List<PriceData> readValueData(String filename) {
                ...
                for (int i = 0; i < jsonData.data.length; ++i) {
                    ...
                    data.add(new PriceData(row[0].longValue(),
                            row[1].doubleValue()));
                }
            ...
            private List<OhlcData> readOhlcData(String filename) {
                ...
                for (int i = 0; i < jsonData.data.length; ++i) {
                    Number[] row = jsonData.data[i];
                    data.add(new OhlcData(row[0].longValue(),
                            row[1].doubleValue(), row[2].doubleValue(),
            ...
            private static JsonData readJsonDataFrom(String filename) {
                ...
                try {
                    ...
                    jsonData = mapper.readValue(
                            new InputStreamReader(CompatChartComponents.class
                                    .getResourceAsStream(filename)),
                            JsonData.class);

                } catch (IOException e) {
                    throw new RuntimeException(
                            "Cannot read data from " + filename, e);
                }
                return jsonData;
            }
