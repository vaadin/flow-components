...
If the license is valid, it will be saved to the local storage of the browser and you will not see the pop-up again. License dialog will only be shown in development environment when accessing the web page using localhost or 127.0.0.1.
