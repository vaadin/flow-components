 ...
 */
@Tag("vaadin-map")
@NpmPackage(value = "@vaadin/map", version = "25.1.0-alpha7")
...
public class Map extends MapBase {
    ...
    /**
     * Binds the given signal to the center of the map's viewport.
     * <p>
    ...
    /**
     * Binds the given signal to the zoom level of the map's viewport.
     * <p>
