...
public class MapEventsIT extends AbstractComponentIT {
    ...
    public void changeViewPort_viewStateUpdated() {
        ...
        map.evaluateOLExpression("map.getView().setCenter([4849385.650796606, 5487570.011434158]);");
        map.evaluateOLExpression("map.getView().setRotation(5);");
        map.evaluateOLExpression("map.getView().setZoom(6)");

        Assert.assertEquals("4849385.650796606;5487570.011434158;5.0;6.0", stateTextDiv.getText());
    }
    ...
    public void changeViewPort_correctEventDataReceived() {
        ...
        Assert.assertEquals("4849385.650796606;5487570.011434158;5.0;6.0", eventDataDiv.getText());
    }
