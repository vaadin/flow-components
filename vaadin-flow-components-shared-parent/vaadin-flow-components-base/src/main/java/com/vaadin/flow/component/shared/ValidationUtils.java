...
public class ValidationUtils {
    public static <T> ValidationResult checkRequired(boolean required, T value, T emptyValue) {
    ...
    public static <T extends Comparable<T>> ValidationResult checkGreaterThanMax(T value, T maxValue) {
    ...
    public static <T extends Comparable<T>> ValidationResult checkSmallerThanMin(T value, T minValue) {
