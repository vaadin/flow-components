 ...
 */
@NpmPackage(value = "@vaadin/a11y-base", version = "25.3.0-rc1")
@NpmPackage(value = "@vaadin/component-base", version = "25.3.0-rc1")
@NpmPackage(value = "@vaadin/field-base", version = "25.3.0-rc1")
@NpmPackage(value = "@vaadin/input-container", version = "25.3.0-rc1")
@NpmPackage(value = "@vaadin/lit-renderer", version = "25.3.0-rc1")
@NpmPackage(value = "@vaadin/overlay", version = "25.3.0-rc1")
